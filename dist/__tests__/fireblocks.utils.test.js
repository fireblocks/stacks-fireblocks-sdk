...
describe("validateApiCredentials", () => {
    ...
    describe("API key validation", () => {
        it("accepts valid UUID v4 API keys", () => {
            expect(() => {
                (0, fireblocks_utils_1.validateApiCredentials)(validApiKey, validInlinePem);
            }).not.toThrow();
        });
        it("rejects invalid UUID format", () => {
            expect(() => {
                (0, fireblocks_utils_1.validateApiCredentials)("not-a-uuid", validInlinePem);
            }).toThrow("API key is not a valid UUID v4");
        });
        it("rejects empty API key", () => {
            expect(() => {
                (0, fireblocks_utils_1.validateApiCredentials)("", validInlinePem);
            }).toThrow("API key is not a valid UUID v4");
        });
        it("rejects UUID v1 format (wrong version digit)", () => {
            ...
            expect(() => {
                (0, fireblocks_utils_1.validateApiCredentials)(uuidV1, validInlinePem);
            }).toThrow("API key is not a valid UUID v4");
        });
        it("rejects malformed UUIDs", () => {
            ...
            malformed.forEach((key) => {
                expect(() => {
                    (0, fireblocks_utils_1.validateApiCredentials)(key, validInlinePem);
                }).toThrow("API key is not a valid UUID v4");
            });
        });
        it("is case insensitive for UUID", () => {
            ...
            expect(() => (0, fireblocks_utils_1.validateApiCredentials)(upperCase, validInlinePem)).not.toThrow();
            expect(() => (0, fireblocks_utils_1.validateApiCredentials)(lowerCase, validInlinePem)).not.toThrow();
        });
    });
    describe("inline PEM detection", () => {
        it("accepts inline PEM strings without file check", () => {
            ...
            pemVariants.forEach((pem) => {
                expect(() => {
                    (0, fireblocks_utils_1.validateApiCredentials)(validApiKey, pem);
                }).not.toThrow();
            });
        });
        it("rejects non-existent file paths", () => {
            expect(() => {
                (0, fireblocks_utils_1.validateApiCredentials)(validApiKey, "/non/existent/path/to/key.pem");
    ...
    describe("vaultAccountId validation", () => {
        it("accepts numeric vault IDs", () => {
            expect(() => {
                (0, fireblocks_utils_1.validateApiCredentials)(validApiKey, validInlinePem, 0);
            }).not.toThrow();
            expect(() => {
                (0, fireblocks_utils_1.validateApiCredentials)(validApiKey, validInlinePem, 123);
            }).not.toThrow();
        });
        it("accepts string numeric vault IDs", () => {
            ...
            expect(() => {
                (0, fireblocks_utils_1.validateApiCredentials)(validApiKey, validInlinePem, "456");
            }).not.toThrow();
        });
        it("accepts undefined vault ID (optional parameter)", () => {
            expect(() => {
                (0, fireblocks_utils_1.validateApiCredentials)(validApiKey, validInlinePem, undefined);
            }).not.toThrow();
        });
        it("rejects non-numeric string vault IDs", () => {
            expect(() => {
                (0, fireblocks_utils_1.validateApiCredentials)(validApiKey, validInlinePem, "abc");
