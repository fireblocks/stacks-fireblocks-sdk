...
const validateVaultId = (req, res, next) => {
 ...
 *         description: Internal server error
 */
router.get("/:vaultId/btc-rewards-address", validateVaultId, controller.getBtcRewardsAddress);
/**
 * @openapi
 * /{vaultId}/publicKey:
 *   get:
 ...
 *         description: Internal server error
 */
router.get("/transactions/:txId", controller.getTxStatusById);
// Pox Info
/**
 * @openapi
 * /poxInfo:
 ...
 *         description: Internal server error.
 */
router.get("/:vaultId/transactions", validateVaultId, controller.getTransactionHistory);
/**
 * @openapi
 * /{vaultId}/transfer:
 *   post:
 ...
 *         description: Internal server error
 */
router.post("/:vaultId/transfer", validateVaultId, controller.createTransaction);
/**
 * @openapi
 ...
 *         description: Internal server error
 */
router.post("/:vaultId/stacking/pool/delegate", validateVaultId, controller.delegateToPool);
/**
 * @openapi
 ...
 *         description: Internal server error
 */
router.post("/:vaultId/stacking/pool/allow-contract-caller", validateVaultId, controller.allowContractCaller);
/**
 * @openapi
 ...
 *         description: Internal server error
 */
router.post("/:vaultId/revoke-delegation", validateVaultId, controller.revokeDelegation);
/**
 * @openapi
 ...
 *         description: Internal server error
 */
router.post("/:vaultId/replace-transaction", validateVaultId, controller.replaceTransaction);
// Pool metrics
/**
 * @openapi
 * /metrics:
